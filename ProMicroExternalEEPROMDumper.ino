...
const uint32_t totalKBytes = 1;         //for read and write test functions
extEEPROM eep(kbits_2, 1, 8);         //device size, number of devices, page size
...
void setup(void)
{
    ...
    // Here is some sample code to write data to the EEPROM, if you are working on a lab demo
    ...
    //Here is the code to read bytes of data from the External EEPROM
    dump(0, 256);            //read 256 bytes
